...
import com.example.boardprojectadmin.dto.security.BoardAdminPrincipal;
import com.example.boardprojectadmin.dto.security.KakaoOAuth2Response;
import com.example.boardprojectadmin.service.AdminAccountService;
...
public class SecurityConfig {
     ...
     * @return {@link OAuth2UserService} OAuth2 인증 사용자 정보를 읽어드리고 처리하는 서비스 인스턴스 반환
     */
    @Bean
